...
public class AppTitle extends LinearLayout {
    ...
    public AppTitle setLeftText(int text) {
        mLeftText.setVisibility(VISIBLE);
        mLeftText.setText(getResources().getString(text));
        return this;
    }

    public AppTitle setLeftTextColor(int color) {
        mLeftText.setTextColor(getResources().getColor(color));
        return this;
    }

    public AppTitle setLeftTextSize(int size) {
    ...
    public AppTitle setCenterTitle(int text) {
        mCenterTitle.setVisibility(VISIBLE);
        mCenterTitle.setText(getResources().getString(text));
        return this;

    }

    public AppTitle setCenterTitleColor(int color) {
        mCenterTitle.setTextColor(getResources().getColor(color));
        return this;

    }

    public AppTitle setCenterTitleSize(int size) {
    ...
    public AppTitle setRightText(int text) {
        mRightText.setVisibility(VISIBLE);
        mRightText.setText(getResources().getString(text));
        return this;

    }

    public AppTitle setRightTextColor(int color) {
        mRightText.setTextColor(getResources().getColor(color));
        return this;

    }

    public AppTitle setRightTextSize(int size) {
